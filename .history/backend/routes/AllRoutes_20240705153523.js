...
// // C:/Users/SAINATH/Downloads/ffmpeg-7.0.1-full_build/ffmpeg-7.0.1-full_build/bin/ffmpeg.exe
...
//         const response = await axios.post("https://api.assemblyai.com/v2/upload", formData, {
//             headers: {
//                 "authorization": "3b77cc76bafa458597a81f59ec016e71",
//                 ...formData.getHeaders(),
//             },
//         });
//         return response.data.upload_url;
...
//         const videoPath = path.join(__dirname, "..", "videos", fileName);
//         const outputAudioPath = videoPath.replace(".webm", ".mp3");
//         await convertVideoToAudio(videoPath, outputAudioPath);

//         const audioUrl = await uploadAudioToAssemblyAI(outputAudioPath);
//         const transcribedText = await transcribeAudioToText(audioUrl);

//         const outputTextFileName = fileName.replace(".webm", ".txt");
//         const outputTextFilePath = path.join(__dirname, "..", "videos", outputTextFileName);
//         await writeFile(outputTextFilePath, transcribedText);
...
// ffmpeg.setFfmpegPath('C:/ffmpeg/ffmpeg-master-latest-win64-gpl/ffmpeg.exe'); 
...
ffmpeg.setFfmpegPath(''); // Adjust the path as needed); // Adjust the path as needed
