...
import { Menu, MenuItem, ProSidebarProvider } from "react-pro-sidebar"; // Import ProSidebarProvider
...
function App() {
  ...
  return (
    <ProSidebarProvider> {/* Wrap your component tree with ProSidebarProvider */}
      <>
        <Nav />
