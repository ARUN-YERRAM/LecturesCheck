...
# Function to extract transcript from local video file
...
# Function to save summary and thumbnail
...
# Streamlit app
st.title("YouTube/Local Video Transcript to Detailed Notes Converter LLM")
...
# Function to process video and generate summary
def process_video(youtube_link, local_video_file, language_code):
    ...
    if local_video_file:
        ...
        # Save a frame from the local video as thumbnail
        video = VideoFileClip(local_video_path)
