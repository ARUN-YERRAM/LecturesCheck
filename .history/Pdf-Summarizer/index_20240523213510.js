...
const endpointURL = process.env.OCTOAI_ENDPOINT_URL || 'default_endpoint_url_here'; // Replace with the correct default endpoint URL

// Connect to the OctoAI Client
const client = new Client({
    apiKey: process.env.OCTOAI_TOKEN,
    endpoint: endpointURL // Ensure endpoint is specified correctly if required
});
