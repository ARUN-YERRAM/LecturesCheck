...
const UploadForm = ({ getAllMedias }) => {
  ...
  return (
    <>
      <div className="uploadpdf container d-flex justify-content-center align-content-center pt-5" style={{"width": "100vh", "height":"100vh"}}>
      <form className="pdfform p-5" onSubmit={handleSubmit}>
        ...
        <button className="btn btn-primary mt-4" onClick={navigateToLot} style={{marginLeft:"12px"}}>
            View
          </button>
        </form>
