                    ...
                    <div className="card cards">
                            <ul class="list-unstyled lists " style={{ fontSize: "105%", fontWeight: "bold" }}>
                               <li><h5>COMPUTER ORGANIZATION AND ARCHITECTURE</h5></li>
                                ...
                                <button className="btn button mt-1 " style={{ backgroundColor:customPrimaryColor, color: "white" }} onClick={hangleNextPage1} >Upload</button>
                            </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div className="column colomn">
                        <div className="card cards">
                            <ul class="list-unstyled lists " style={{ fontSize: "105%", fontWeight: "bold" }}>
                                ...
                                <button className="btn button mt-1 " style={{ backgroundColor: customPrimaryColor, color: "white" }} onClick={hangleNextPage3} >Upload</button>
                            </ul>
                        </div>
                    </div>
                </div>
